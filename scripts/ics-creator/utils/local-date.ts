...
export const localDate = (utcDate: Date, timezone: string): {day: number, month: number, year: number, hour: number, minute: number} => {
  ...
  const formatedLocalDate =  formatTimestamp(dateStr, timezone, 
